...
echo "╔══════════════════════════════════════════════════╗"
echo "║          Welcome to Cloud Hustlers Cloud  Tutorial!     ║"
echo "║  Let's start meanwhile hit the like button       ║"
echo "║  And subscribe to the channel.      ║"
echo "╚══════════════════════════════════════════════════╝"
echo ""
echo "📢 Don't forget to subscribe to Cloud Hustlers YouTube channel:"
echo "  https://www.youtube.com/@CloudHustlers/videos"
...
echo ""
echo "📢 Remember to subscribe to Cloud hustlers YouTube channel:"
echo "  https://www.youtube.com/@CloudHustlers/videos"
